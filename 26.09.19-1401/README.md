...
Return trueif the circle and rectangle are overlapped otherwise returnfalse. In other words, check if there is any point (x_i, y_i) that belongs to the circle and the rectangle at the same time.
